...
import {useStockBySupplierQuery} from "@/redux/feature/stockAPI/stockAPI.js";
import {Table, TableBody, TableCell, TableHead, TableHeader, TableRow} from "@/components/ui/table.jsx";

const GetStockSupplier = () => {
    const {id}=useParams();
    const {data}=useStockBySupplierQuery(id)
...
export default GetStockSupplier;