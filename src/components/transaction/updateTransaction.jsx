...
import {useGetTransactionQuery, useUpdateTransactionMutation} from "@/redux/feature/transactionAPI/transactionAPI.js";
...
const UpdateTransaction = () => {
    ...
    useEffect(() => {
        if(data?.data){
            const transactionData = data?.data.find(item => item.id.toString() === id);
            if(transactionData){
                setinputForm({
