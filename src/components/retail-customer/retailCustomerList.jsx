...
import {
    useDeleteMutation, usePaginateQuery,useSearchQuery
} from "@/redux/feature/retailcustomerAPI/retailcustomerAPI.js";
...
const RetailCustomerList = () => {
    ...
    const {data:paginateData,refetch}=usePaginateQuery(page)
    const {data:searchData}=useSearchQuery(search)
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-4">
                ...
                />
                <Link to='/create-retail-customer'>
                    <Button className="bg-blue-500 text-white">Create Retail-Customer</Button>
                </Link>
            </div>
                ...
                >
                  {item.status}
                            ...
                            <TableCell className="flex space-x-2">
                                <Link to={`/update-retail-customer/${item.id}`}>
