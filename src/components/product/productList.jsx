...
import {
    ...
    usePaginationProductQuery,
    useSearchProductQuery
} from "@/redux/feature/productAPI/productAPI.js";
...
const ProductList = () => {
    ...
    const { data: paginatedData, refetch } = usePaginationProductQuery(page);
    ...
    const HandleonDelete=async(id)=>{
        ...
        if(result.isConfirmed){
            try {
                ...
                await showSuccess("Successfully deleted product")
                refetch()
            }catch(e){
            ...
            <Table>
                ...
                >
                  {item.status}
                            ...
                            <TableCell>
                                <Link to={`/get-productstock/${item.id}`}>
